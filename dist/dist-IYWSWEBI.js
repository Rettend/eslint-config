...
var require_context = __commonJS({
  "node_modules/.pnpm/@typescript-eslint+utils@6.19.0_eslint-ts-patch@8.56.0-0_typescript@5.3.3/node_modules/@typescript-eslint/utils/dist/eslint-utils/context.js"(exports) {
    ...
    function getDeclaredVariables(context, node) {
      ...
      return sourceCode.getDeclaredVariables?.(node) ?? context.getDeclaredVariables(node);
    }
...
var require_utils = __commonJS({
  "node_modules/.pnpm/eslint-plugin-solid@0.13.1_eslint-ts-patch@8.56.0-0_typescript@5.3.3/node_modules/eslint-plugin-solid/dist/utils.js"(exports) {
    ...
    var isFunctionNode = (node) => !!node && FUNCTION_TYPES.includes(node.type);
    exports.isFunctionNode = isFunctionNode;
    var PROGRAM_OR_FUNCTION_TYPES = ["Program"].concat(FUNCTION_TYPES);
    var isProgramOrFunctionNode = (node) => !!node && PROGRAM_OR_FUNCTION_TYPES.includes(node.type);
    exports.isProgramOrFunctionNode = isProgramOrFunctionNode;
    var isJSXElementOrFragment = (node) => node?.type === "JSXElement" || node?.type === "JSXFragment";
    ...
    function findInScope(node, scope, predicate) {
      const found = (0, exports.find)(node, (node2) => node2 === scope || predicate(node2));
      return found === scope && !predicate(node) ? null : found;
    }
    exports.findInScope = findInScope;
    var getCommentBefore = (node, sourceCode) => sourceCode.getCommentsBefore(node).find((comment) => comment.loc.end.line >= node.loc.start.line - 1);
    exports.getCommentBefore = getCommentBefore;
    var getCommentAfter = (node, sourceCode) => sourceCode.getCommentsAfter(node).find((comment) => comment.loc.start.line === node.loc.end.line);
    ...
    exports.default = createRule({
      ...
      create(context) {
        ...
        const onFunctionExit = (node) => {
          if ((0, utils_2.getFunctionName)(node)?.match(/^[a-z]/) || node.parent?.type === "JSXExpressionContainer" || node.parent?.type === "CallExpression" && node.parent.arguments.some((n) => n === node) && !node.parent.callee.name?.match(/^[A-Z]/)) {
      ...
      create(context) {
        ...
        return {
          JSXAttribute(node) {
            ...
            if (node.value?.type === "JSXExpressionContainer" && node.value.expression.type !== "JSXEmptyExpression" && node.value.expression.type !== "ArrayExpression" && (staticValue = getStaticValue(node.value.expression, context.getScope())) !== null && (typeof staticValue.value === "string" || typeof staticValue.value === "number")) {
              context.report({
                node,
                ...
                if (correctSource != null && correctSource !== source) {
                  context.report({
                    ...
                    fix(fixer) {
                      ...
                      const correctDeclaration = program.body.find((node2) => node2.type === "ImportDeclaration" && node2.source.value === correctSource);
                      ...
                      const firstSolidDeclaration = program.body.find((node2) => node2.type === "ImportDeclaration" && isSource(node2.source.value));
                      return [
                        (0, utils_2.removeSpecifier)(fixer, sourceCode, specifier),
...
var require_is_html = __commonJS({
  "node_modules/.pnpm/is-html@2.0.0/node_modules/is-html/index.js"(exports, module) {
    "use strict";
    init_esm_shims();
          ...
          JSXOpeningElement(node) {
            for (const { from, to } of reactSpecificProps) {
              ...
              if (classNameAttribute) {
                const fix = !(0, utils_2.jsxHasProp)(node.attributes, to) ? (fixer) => fixer.replaceText(classNameAttribute.name, to) : void 0;
                context.report({
  ...
  "node_modules/.pnpm/eslint-plugin-solid@0.13.1_eslint-ts-patch@8.56.0-0_typescript@5.3.3/node_modules/eslint-plugin-solid/dist/rules/prefer-classlist.js"(exports) {
    ...
    exports.default = createRule({
      ...
      create(context) {
        ...
        return {
          JSXAttribute(node) {
            if (["class", "className"].indexOf((0, utils_2.jsxPropName)(node)) === -1 || (0, utils_2.jsxHasProp)(node.parent?.attributes ?? [], "classlist")) {
              return;
            }
        ...
        return {
          CallExpression(node) {
            ...
            if (callOrChain.parent?.type === "JSXExpressionContainer" && (0, utils_2.isJSXElementOrFragment)(callOrChain.parent.parent)) {
              if (node.callee.type === "MemberExpression" && getPropertyName(node.callee) === "map" && node.arguments.length === 1 && (0, utils_2.isFunctionNode)(node.arguments[0])) {
                const mapFnNode = node.arguments[0];
        ...
        const logicalExpressionHandler = (node) => {
          if (node.operator === "&&" && EXPENSIVE_TYPES.includes(node.right.type)) {
            context.report({
              ...
              fix: (fixer) => fixer.replaceText(node.parent?.type === "JSXExpressionContainer" && (0, utils_2.isJSXElementOrFragment)(node.parent.parent) ? node.parent : node, `<Show when={${sourceCode.getText(node.left)}}>${putIntoJSX(node.right)}</Show>`)
            });
          }
        };
        const conditionalExpressionHandler = (node) => {
          if (EXPENSIVE_TYPES.includes(node.consequent.type) || EXPENSIVE_TYPES.includes(node.alternate.type)) {
            context.report({
              ...
              fix: (fixer) => fixer.replaceText(node.parent?.type === "JSXExpressionContainer" && (0, utils_2.isJSXElementOrFragment)(node.parent.parent) ? node.parent : node, `<Show when={${sourceCode.getText(node.test)}} fallback={${sourceCode.getText(node.alternate)}}>${putIntoJSX(node.consequent)}</Show>`)
            });
          }
        };
        return {
      ...
      create(context, [options]) {
        ...
        const matchTrackedScope = (trackedScope, node) => {
          switch (trackedScope.expect) {
            ...
            case "expression":
              return Boolean((0, utils_2.findInScope)(node, currentScope().node, (node2) => node2 === trackedScope.node));
          }
        };
        ...
        const checkForSyncCallbacks = (node) => {
          if (node.arguments.length === 1 && (0, utils_2.isFunctionNode)(node.arguments[0]) && !node.arguments[0].async) {
        ...
        const checkForTrackedScopes = (node) => {
          const pushTrackedScope = (node2, expect) => {
            ...
            if (expect !== "called-function" && (0, utils_2.isFunctionNode)(node2) && node2.async) {
              context.report({
                node: node2,
          ...
          if (node.type === "JSXExpressionContainer") {
            if (node.parent?.type === "JSXAttribute" && /^on[:A-Z]/.test(sourceCode.getText(node.parent.name)) && node.parent.parent?.type === "JSXOpeningElement" && node.parent.parent.name.type === "JSXIdentifier" && (0, utils_2.isDOMElementName)(node.parent.parent.name.name)) {
              pushTrackedScope(node.expression, "called-function");
            } else if (node.parent?.type === "JSXAttribute" && node.parent.name.type === "JSXNamespacedName" && node.parent.name.namespace.name === "use" && (0, utils_2.isFunctionNode)(node.expression)) {
              pushTrackedScope(node.expression, "called-function");
            ...
            } else if (node.parent?.type === "JSXAttribute" && node.parent.name?.type === "JSXIdentifier" && /^static[A-Z]/.test(node.parent.name.name) && node.parent.parent?.type === "JSXOpeningElement" && node.parent.parent.name.type === "JSXIdentifier" && !(0, utils_2.isDOMElementName)(node.parent.parent.name.name)) {
            } else if (node.parent?.type === "JSXAttribute" && node.parent.name.name === "ref" && (0, utils_2.isFunctionNode)(node.expression)) {
              pushTrackedScope(node.expression, "called-function");
            ...
            if (node.left.type === "MemberExpression" && node.left.property.type === "Identifier" && (0, utils_2.isFunctionNode)(node.right) && /^on[a-z]+$/.test(node.left.property.name)) {
        ...
        return {
          ...
          "JSXElement > JSXExpressionContainer > :function"(node) {
            if ((0, utils_2.isFunctionNode)(node) && node.parent?.type === "JSXExpressionContainer" && node.parent.parent?.type === "JSXElement") {
...
var require_self_closing_comp = __commonJS({
  "node_modules/.pnpm/eslint-plugin-solid@0.13.1_eslint-ts-patch@8.56.0-0_typescript@5.3.3/node_modules/eslint-plugin-solid/dist/rules/self-closing-comp.js"(exports) {
    ...
    function isComponent(node) {
      return node.name.type === "JSXIdentifier" && !(0, utils_2.isDOMElementName)(node.name.name) || node.name.type === "JSXMemberExpression";
    }
...
var require_kebab_case = __commonJS({
  "node_modules/.pnpm/kebab-case@1.0.2/node_modules/kebab-case/index.js"(exports, module) {
    "use strict";
    init_esm_shims();
...
var require_all = __commonJS({
  "node_modules/.pnpm/known-css-properties@0.24.0/node_modules/known-css-properties/data/all.json"(exports, module) {
    module.exports = {
      properties: [
        "-epub-caption-side",
        "-epub-hyphens",
...
var require_known_css_properties = __commonJS({
  "node_modules/.pnpm/known-css-properties@0.24.0/node_modules/known-css-properties/index.js"(exports, module) {
    "use strict";
    init_esm_shims();
      ...
      create(context) {
        return {
          JSXAttribute(node) {
            ...
            if ((isNamespacedHandler || isNormalEventHandler) && node.value?.type === "JSXExpressionContainer" && (0, utils_2.trace)(node.value.expression, context.getScope()).type === "ArrayExpression") {
              context.report({
                node,
...
var require_recommended = __commonJS({
  "node_modules/.pnpm/eslint-plugin-solid@0.13.1_eslint-ts-patch@8.56.0-0_typescript@5.3.3/node_modules/eslint-plugin-solid/dist/configs/recommended.js"(exports, module) {
    "use strict";
    init_esm_shims();
...
var require_typescript = __commonJS({
  "node_modules/.pnpm/eslint-plugin-solid@0.13.1_eslint-ts-patch@8.56.0-0_typescript@5.3.3/node_modules/eslint-plugin-solid/dist/configs/typescript.js"(exports, module) {
    "use strict";
    init_esm_shims();
    var __importDefault = exports && exports.__importDefault || function(mod) {
      return mod && mod.__esModule ? mod : { "default": mod };
...
var require_dist5 = __commonJS({
  "node_modules/.pnpm/eslint-plugin-solid@0.13.1_eslint-ts-patch@8.56.0-0_typescript@5.3.3/node_modules/eslint-plugin-solid/dist/index.js"(exports, module) {
    init_esm_shims();
    var __importDefault = exports && exports.__importDefault || function(mod) {
      return mod && mod.__esModule ? mod : { "default": mod };
    };
